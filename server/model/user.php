 ...
 */
	class User{
		...
		function __construct($id, $username, $password,$firstname,$lastname,$dateofbirth,$email,$phonenumber,$gender,$healthcardno,$versioncode,$cardexpirydate){
			$this->setUserId($id);
